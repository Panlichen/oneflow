...
class OfCollectiveBoxingReduceTaskNode : public TransportTaskNode {
 public:
  OF_DISALLOW_COPY_AND_MOVE(OfCollectiveBoxingReduceTaskNode);
  OfCollectiveBoxingReduceTaskNode() = default;
  ~OfCollectiveBoxingReduceTaskNode() override = default;
